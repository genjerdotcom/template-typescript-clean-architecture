...
let UserDeleteController = class UserDeleteController {
    ...
    async handle(req, res) {
        const data = (0, class_transformer_1.plainToClass)(dtos_1.DeleteUserDto, { ...req.params, ...req.body });
...
exports.UserDeleteController = UserDeleteController = __decorate([
    ...
    __param(0, (0, tsyringe_1.inject)('DeleteUserUseCase')),
    __metadata("design:paramtypes", [usecases_1.DeleteUserUseCase])
